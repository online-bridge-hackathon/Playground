...
if __name__ == "__main__":
    ...
    # verification file of single-use tablekeys (these files would be regenerated as needed)
    ...
    table_list = {'table_key': player_table_key, 'table_create_time': dt_string, 'pubsub': [ ptable, vtable ],'seat_keys': seat_keys}
